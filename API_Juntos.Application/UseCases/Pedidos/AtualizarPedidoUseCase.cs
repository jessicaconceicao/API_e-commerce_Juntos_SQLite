...
namespace API_Juntos.Application.UseCases.Pedidos
{
...

    {
        ...
        {
            var pedido = await _repository.ListarPorIdParaAtualizar(request.IdPedido); //acessa o repositório para chamar o método listar por id para identificar os dados do usuário atualizar
