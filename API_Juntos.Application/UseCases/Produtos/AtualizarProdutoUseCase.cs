...
namespace API_Juntos.Application.UseCases.Produtos
{
   ...
   
    {
        ...
        {
            var produto = await _repository.ListarPorIdParaAtualizar(request.IdProduto); //acessa o repositório para chamar o método listar por id para identificar os dados do usuário atualizar
